...
ActiveRecord::Schema.define(version: 20151108180122) do
  ...
  create_table "sponored_posts", force: :cascade do |t|
    t.string   "title"
    t.text     "body"
    t.integer  "price"
    t.integer  "topic_id"
  ...
  add_index "sponored_posts", ["topic_id"], name: "index_sponored_posts_on_topic_id"
